...
| [`Sgcop/RSpec/NoMethodCallInExpectation`](https://github.com/SonicGarden/sgcop/blob/main/lib/rubocop/cop/sgcop/rspec/no_method_call_in_expectation.rb) | RSpecのexpectationでメソッド呼び出しではなくリテラル値や変数の使用を推奨 | ❌ |

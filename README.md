...
| [`Sgcop/RSpec/NoVariableExpectation`](https://github.com/SonicGarden/sgcop/blob/main/lib/rubocop/cop/sgcop/rspec/no_variable_expectation.rb) | RSpecのexpectationで変数の代わりにリテラル値の使用を推奨 | ❌ |
